export const translations = {
  es: {
    ...
    home: {
      ...
      about_text: 'Desarrollador Full Stack especializado en sistemas de salud, gestión empresarial y comercio. Apasionado por la tecnología y el impacto que genera en el mundo. Viviendo en Santiago, Chile. En mis tiempos libres hago patinaje urbano.',
      stack_title: 'Stack',
  ...
  en: {
    ...
    home: {
      ...
      about_text: 'Full Stack Developer specialized in healthcare, enterprise and commerce systems. Passionate about technology and the impact it creates in the world. Living in Santiago, Chile. In my free time I do urban skating.',
      stack_title: 'Stack',
